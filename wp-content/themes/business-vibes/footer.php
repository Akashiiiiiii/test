...
?>
			...
			<div class="ascendoor-wrapper">
				<div class="site-footer-bottom-wrapper">
					<div class="site-info">
						<?php
						/**
						 * Hook: business_vibes_footer_copyright.
						 *
						 * @hooked - business_vibes_output_footer_copyright_content - 10
						 */
						do_action( 'business_vibes_footer_copyright' );
						?>
					</div><!-- .site-info -->
				</div>
			</div>	
	...
	<?php
	$is_scroll_top_active = get_theme_mod( 'business_vibes_scroll_top', true );
